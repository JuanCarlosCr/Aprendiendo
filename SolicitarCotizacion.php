    ...
    <body>
        ...
        <div id="about" class="about">
            <div class="container">
                ...
                <h2>Le ofrecemos para su cotizaci&oacuten, un pronto contacto con un agente de ventas de Aprendiendo, garantia en los servicios y administracion y procesamiento sin costo alguno.</h2>
                <div class="specialty-grids-top">
                    ...
                    <div class="col-md-4 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
                        <figure class="icon">
                            <span class="glyphicon glyphicon-erase a2" aria-hidden="true"></span>
                        </figure>
                ...
                <div class="buttons">
                    <div class="button">
                        <h5><a href="Destinos.php" id="Destinos">Destinos</a></h5>
                    </div>
                    <div class="button2">
                        <h5><a href="Cotizacion.php"> <!--data-toggle="modal" data-target="#myModal2"-->Cotizaci&oacuten</a></h5>
                    </div>
                </div>
                <!-- Modal1 -->
                        ...
                        <div class="modal-content abt-w3l">
                            <div class="modal-header">
                                ...
                                <form action="#" method="post" class="mod2">
                                    <ul>
                                        <li class="text">Categoria :  </li>
                                        <li class="agileits-main"><select name="Categoria" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Idioma :  </li>
                                        <li class="agileits-main"><select name="Idioma" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Pa&iacutes  :  </li>
                                        <li class="agileits-main"><select name="Pais" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Ciudad  :  </li>
                                        <li class="agileits-main"><select name="Ciudad" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Tipo Curso  :  </li>
                                        <li class="agileits-main"><select name="TipoCurso" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Tipo Alojamiento  :  </li>
                                        <li class="agileits-main"><select name="TipoAlojamiento" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Fecha Inicio  :  </li>
                                        <li class="agileits-main"><input name="FechaInicio" type="date" required></li>
                                    </ul>
                                    <ul>
                                        <li class="text">Duraci&oacuten  :  </li>
                                        <li class="agileits-main"><select name="Duracion" type="text" required>
                                                <option>Aaaa</option>
                                                <option>Bbbb</option>
                                                <option>Cccc</option>
                                            </select>
                                    ...
                                    <ul>
                                        <li class="text">Preguntas/Peticiones  :  </li>
                                        <li class="agileits-main"> <textarea name="Message" type="text" required=""> </textarea>
                                        </li>
                                    </ul>
                                    <h4>Datos Personales</h4>
                                    <ul>
                                        <li class="text">Documento  :  </li>
                                        <li class="agileits-main"> <input name="Message" type="number" required="">
                                        </li>
                                    </ul>
                                    <div class="clear"></div>
